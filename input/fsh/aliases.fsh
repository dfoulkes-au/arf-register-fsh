...
Alias:   $IdTypeAU = http://terminology.hl7.org.au/CodeSystem/v2-0203
Alias:   $IndigStatus = https://healthterminologies.gov.au/fhir/CodeSystem/australian-indigenous-status-1
...
// provider role identifier links
